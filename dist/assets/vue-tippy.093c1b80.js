...
import { A as defineComponent, B as ref, C as onMounted, D as nextTick, E as watch, G as unref, h, H as onUnmounted, I as isRef, J as isReactive, K as getCurrentInstance, L as isVNode, M as render$1, d as definePlugin } from "./index.2c4f64fa.js";
/*!
...
const TippyComponent = defineComponent({
  ...
  setup(props2, { slots, emit, expose }) {
    ...
    expose(exposed);
    return () => {
      let exposedUnref = __spreadValues({
        elem: elem.value,
        contentElem: contentElem.value,
        mounted: mounted.value
      }, Object.keys(tippy2).reduce((acc, key) => {
        acc[key] = unref(tippy2[key]);
        return acc;
      }, {}));
