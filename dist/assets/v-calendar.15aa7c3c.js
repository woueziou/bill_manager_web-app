import { r as reactive, f as computed, h, o as openBlock, i as createBlock, w as withCtx, j as renderSlot, T as Transition, k as createElementBlock, l as createBaseVNode, n as normalizeStyle, m as normalizeClass, p as createCommentVNode, q as createTextVNode, t as toDisplayString, s as resolveComponent, v as createVNode, F as Fragment, x as renderList, y as withModifiers, z as mergeProps, d as definePlugin } from "./index.2c4f64fa.js";
...
const _sfc_main$5 = {
  ...
  render() {
    ...
    }, this.backgrounds.map(({ key, wrapperClass, class: bgClass, style: style2 }) => h("div", {
      key,
      class: wrapperClass
    }, [
      h("div", {
    ...
    const dotsLayer = () => this.hasDots && h("div", {
      ...
      h("div", {
        class: "vc-dots"
      }, this.dots.map(({ key, class: bgClass, style: style2 }) => h("span", {
        key,
        class: bgClass,
        style: style2
      })))
    ...
    const barsLayer = () => this.hasBars && h("div", {
      ...
      h("div", {
        class: "vc-bars"
      }, this.bars.map(({ key, class: bgClass, style: style2 }) => h("span", {
        key,
        class: bgClass,
        style: style2
      })))
...
var style = "";
var vCalendar = definePlugin(({ app }) => {
  app.use(setup, {});
  app.component("VCalendar", _sfc_main$3);
  app.component("VDatePicker", _sfc_main);
});
export { vCalendar as default };
